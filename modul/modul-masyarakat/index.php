			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Selamat datang <b><?= $_SESSION['username'] ?></b> di modul masyarakat</h4>
					</div>
					<div class="card">
                            <div class="card-header">
                                <i class="nav-icon fa fa-user-circle" style="margin-left: 35px;"></i><strong style="margin-left: 5px;">Profil</strong>
                            </div>
                            <div class="card-body">
                                <div class="card col-md-auto">
                                    <div class="card-header" style="margin-right: 10px;">Nik : <?= $_SESSION['nik'] ?></div>
                                    <div class="card-header">Nama : <?= $_SESSION['nama'] ?></div>
                                    <div class="card-header">Username : <?= $_SESSION['username'] ?></div>
                                    <div class="card-header">Tlp : <?= $_SESSION['telp'] ?></div>
                                </div>
                            </div>
                        </div>
				</div>
